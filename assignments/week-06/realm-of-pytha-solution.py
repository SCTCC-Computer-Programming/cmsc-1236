...
class Character:
    ...
    def __init__(self, name, char_class, level, skills, health):
        self.name = name
    ...
    def __str__(self):
        return f"{self.name} (Level {self.level} {self.char_class}) — {self.health} HP"
...
def parse_characters(records):
    ...
    for record in records:
        name, char_class, level, *skills, health = record
        party.append(Character(name, char_class, level, skills, health))
    return party
