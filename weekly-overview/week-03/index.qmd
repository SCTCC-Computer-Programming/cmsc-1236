...
1. Read **Learning Python 6e, Chapters 8–9** (complete).
2. Watch the **Week 3 demo walkthrough** in your CMSC 1236 YouTube playlist and work through the **[Week 3 examples](../../assignments/week-03/week-3-demo.html)** in your Jupyter environment.
3. Complete the **Week 3 D2L quiz** (Chapters 8–9 concepts + demo examples).
